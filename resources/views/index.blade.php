@extends('layouts.app')
@section('title', 'Gerador de Convites')

@section('content')
<div class="content flex flex-col px-8 gap-10 items-center">
    <img src="{{ asset('img/logo-frutificar.png') }}" alt="logo-frutificar" class=" w-4/5">
...
{{-- Scripts diretamente no content para garantir escopo global --}}
